...
@Component({
  selector: 'app-registro-enfer',
  templateUrl: './registro-enfer.component.html',
  styleUrls: ['./registro-enfer.component.less']
})
export class RegistroEnferComponent implements OnInit {
