...
@Component({
  selector: 'app-formulario-paciente2',
  templateUrl: './formulario-paciente2.component.html',
  styleUrls: ['./formulario-paciente2.component.less']
})
export class FormularioPaciente2Component implements OnInit {
